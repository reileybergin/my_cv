...
-   **Textbook**: ["Yet Another R Dataviz (YARD) Book"](https://yardbook.jhelvy.com/), written for [*EMSE 4572 / 6572: Exploratory Data Analysis*](http://eda.seas.gwu.edu/).
-   **Textbook**: ["Programming for Analytics in R"](https://p4a.jhelvy.com/), written for [*EMSE 4571 / 6571: Intro to Programming for Analytics*](http://p4a.seas.gwu.edu/).
-   **Video lecture series** for [*EMSE 6035: Marketing of Technology*](http://madd.seas.gwu.edu/). Six-lecture series on conjoint survey theory and practice. [View on youtube](https://www.youtube.com/playlist?list=PLzFdSE-D7jUQnbczxdjohRqlBBrrsaFFg).
-   **Autograder** for [*EMSE 4571 / 6571: Intro to Programming for Analytics*](http://p4a.seas.gwu.edu/). Students can test and receive automated feedback on their programming assignments.
...
-   *Co-Founder and Organizer*, [GW Coders](https://gwcoders.github.io/): Informal study group to apply computational and data analytics skills in research (2020-present).
